...
<div id="sidebar">
    <ul>
        ...
        <li class="active"><a href="index.php?r=smanagement/log"><i class="icon icon-list-alt"></i> <span>操作日志管理</span></a></li>
...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"><a href="#" class="current">日志管理</a></div>
    </div>
    <!--End-breadcrumbs-->
