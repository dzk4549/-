...
<div id="sidebar">
    <ul>
        ...
        <li class="active"><a href="index.php?r=smanagement/Goods"><i class="icon icon-lemon"></i> <span>货物管理</span></a> </li>
        <li><a href="index.php?r=smanagement/Employee"><i class="icon icon-group"></i> <span>员工管理</span></a> </li>
        <li class="submenu"  class="active"><a href="#"><i class="icon icon-truck"></i> <span>进出货管理</span></a>
            <ul>
...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"><a href="#" class="current">货物管理</a></div>
    </div>
    <!--End-breadcrumbs-->
    <div class="container-fluid">
        <div class="row-fluid"><button data-toggle="modal" data-target="#mymodal" class="btn btn-danger btn-large fr"><i class="icon-plus"></i>添加货物</button></div>
        <div class="row-fluid">
