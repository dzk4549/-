        ...
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" action="http://themedesigner.in/demo/matrix-admin/index.html">
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lg"><i class="icon-user"></i></span><input type="text" placeholder="账户" />
                        </div>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="form-actions">
                    ...
                    <span class="pull-right"><a type="submit" href="index.php?r=Warehouse/Warehouse" class="btn btn-success" /> 登陆</a></span>
                </div>
            </form>
