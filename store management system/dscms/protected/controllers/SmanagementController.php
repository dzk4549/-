...
class SmanagementController extends CController
{
    ...
    public function actionIndex()
    {
        ...
        if ($staff[0]['Spower'] == 3) {
            ...
            $staffs = staff::model()->getStaff();
            $this->render("index", array('staff' => $staff, 'whlist' => $whlist, 'staffs' => $staffs));
        }
    }
    ...
    public function actionWarehouse()
    {
        ...
        $staffs = staff::model()->getStaff();
        $this->render("warehouse", array('staff' => $staff, 'warehouse' => $warehouse, 'goodslist' => $goodslist, 'staffs' => $staffs));
    }
    ...
    public function actionGoods()
    {
        $Sid = Yii::app()->session['SID'];
        $staff = staff::model()->getStaff($Sid);
        $goodslist = $staff[0]['Spower'] == 2 ? goods::model()->getGoodsByWid($staff[0]['SWarehouse']) : $goodslist = goods::model()->getGoods();
        $this->render("goods", array('staff' => $staff, 'goodslist' => $goodslist));
    }
