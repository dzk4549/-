...
<div id="sidebar">
    <ul>
        ...
        <li  class="active" class="submenu"><a href="#"><i class="icon icon-truck"></i> <span>进出货管理</span></a>
            <ul>
...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"><a href="#" class="tip-bottom"><i class="icon-home"></i>进出货管理</a><a href="#" class="current">进货管理</a></div>
    </div>
    <!--End-breadcrumbs-->
    <div class="container-fluid">
        <div class="row-fluid"><button data-toggle="modal" data-target="#mymodal" class="btn btn-danger btn-large fr"><i class="icon-plus"></i>进货单</button></div>
        <div class="row-fluid">
                ...
                <div class="widget-content nopadding">
                    <table class="table table-bordered data-table">
                        ...
                        <tr class="gradeX">
                            ...
                            <td class="center">2016-03-20 20:00:00</td>
                            <td class="center">A场</td>
